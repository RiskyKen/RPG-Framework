...
import moe.plushie.rpg_economy.client.controls.GuiTab;
import moe.plushie.rpg_economy.client.controls.GuiTabPanel;
import moe.plushie.rpg_economy.client.controls.GuiTabbed;
...
public class GuiMailBox extends GuiTabbed {
    ...
    public GuiMailBox(InventoryPlayer inventoryPlayer, TileEntityMailBox tileEntity) {
        ...
        this.inventoryName = tileEntity.getBlockType().getTranslationKey();
