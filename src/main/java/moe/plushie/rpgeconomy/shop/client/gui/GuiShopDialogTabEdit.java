...
public class GuiShopDialogTabEdit extends AbstractGuiDialog {
    ...
    public GuiShopDialogTabEdit(GuiScreen parent, String name, IDialogCallback callback, int width, int height, IShopTab shopTab) {
