...
import moe.plushie.rpg_framework.loot.client.gui.GuiLootTabPoolEditor;
import moe.plushie.rpg_framework.loot.client.gui.GuiLootTabTableEditor;
import net.minecraft.entity.player.EntityPlayer;
import net.minecraftforge.fml.relauncher.Side;
import net.minecraftforge.fml.relauncher.SideOnly;

@SideOnly(Side.CLIENT)
public class GuiManager extends GuiTabbed<ContainerManager> {
